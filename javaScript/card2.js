...
const displayIssues = (issues) => {
    ...
    issues.forEach(issue => {
        ...
        div.innerHTML = ` 
            <div id="${issue.id}"  class="space-y-4 p-4 shadow-md rounded-2xl h-full border-t-5 ${borderColor}">
                <!-- priority head -->
                <div class="flex justify-end p-4"><span class="rounded-full border-2             px-3 py-1 ${bg_Color} ">
